...
export const offerItemsTable = pgTable("offer_items", {
  ...
  rfqItemId: integer("rfq_item_id").notNull().references(() => rfqItemsTable.id),
...
export const insertOfferItemSchema = createInsertSchema(offerItemsTable).omit({ id: true, createdAt: true });
