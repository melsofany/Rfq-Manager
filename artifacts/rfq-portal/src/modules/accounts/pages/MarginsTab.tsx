  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-3">
        ...
        <label
          className="flex items-center gap-2 text-xs text-muted-foreground h-8"
          title="عرض أوامر الشراء حتى غير المسلَّمة"
        >
          <input
            type="checkbox"
            checked={includeAll}
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {lines.map((l) => (
                  ...
                  >
                    <td className="px-3 py-3 font-mono text-xs text-primary">{l.internalPoNo}</td>
                    ...
                    <td className="px-3 py-3 text-xs">{l.finalActualCost ?? "-"}</td>
