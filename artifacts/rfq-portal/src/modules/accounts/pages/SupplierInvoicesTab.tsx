    ...
    <div className="space-y-4">
              ...
              <tbody>
                {invoices.map((inv) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-xs text-amber-600">
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>فاتورة مورد جديدة</DialogTitle>
          </DialogHeader>
          <div className="space-y-3">
            ...
            <div>
              <Label className="text-xs">صافي قيمة التوريد (قبل الضريبة)</Label>
              <Input
                type="number"
            ...
            <label className="flex items-center gap-2 text-xs text-muted-foreground">
              <input
                type="checkbox"
                checked={form.applyWithholding}
                onChange={(e) => setForm({ ...form, applyWithholding: e.target.checked })}
                className="accent-primary"
              />{" "}
              تطبيق الخصم تحت حساب المورد (3%)
            </label>
                ...
                <div className="border border-border rounded p-2">
                  ...
                  {detail.payments.map((p, i) => (
                    <div key={i} className="text-xs flex justify-between">
                      <span className="font-mono text-primary">{p.paymentNo}</span>
