...
import { db, offersTable, suppliersTable, offerItemsTable, rfqItemsTable, auditLogTable } from "@workspace/db";
...
router.get("/offers", requireAuth, async (req, res): Promise<void> => {
  ...
  res.json(offers.map(o => ({
    id: o.offer.id, rfqId: o.offer.rfqId, supplierId: o.offer.supplierId,
    supplierName: o.supplierName, sentLogId: o.offer.sentLogId, employeeId: o.offer.employeeId,
    totalPrice: o.offer.totalPrice ? parseFloat(o.offer.totalPrice) : null,
    generalNotes: o.offer.generalNotes, createdAt: o.offer.createdAt.toISOString(), items: [],
  })));
});
