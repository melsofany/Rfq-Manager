...
- إن رجعت scan_email_items بـ isComplete=false (أو truncated=true في attachmentCoverage) فالترتيب مبني على العينة المفحوصة فقط. اذكر النطاق صريحًا («من أحدث N رسالة من أصل M») ولا تقدّم الترتيب على أنه حصر لكل الرسائل.
