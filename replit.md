...
- Admin: `admin@cortoba-supplies.com` / `admin123`
- Manager: `khalid@cortoba-supplies.com` / `manager123`
- Staff: `sara@cortoba-supplies.com` / `staff123`

## SMTP Configuration

- Host: smtp.gmail.com:587
- User: INFO@CORTOBA-SUPPLIES.COM (set via `SMTP_USER` env var)
